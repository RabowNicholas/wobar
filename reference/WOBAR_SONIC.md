...
### Primary Comps (The Big 3)
- **Of The Trees** — Organic psychedelic bass, dynamic movement, core sonic reference
- **Shlump** — Psychedelic heavy with groove, west coast hip hop influence, danceability + catharsis
- **INZO** — Emotional depth, philosophical samples, heavy + pretty, vocal integration

### Secondary
- **LSDREAM** — Psychedelic intent, visual-sonic integration
- **Tipper** — Sound design mastery, space bass
- **Shpongle** — Ceremonial textures, integration phases

### Act-Specific References
- Act 2: Of The Trees, Tipper
- Act 3: Herbalistek, Kursa, G Jones
- Act 4 Phase 2: INZO, LSDREAM
...
- **Even Into Darkness** — INZO-influenced, F minor, Stranger Things samples
- **MUR** — Heavy hypnotic, Of The Trees-style, Act 3/4 energy
- **ASAP Rocky "Everyday" remix** — 140 BPM, C# minor, heavy dubstep halftime drum pattern, Act 3/4 cusp

---

## Release Strategy
- One original track per month
- Releases structured as Portal EPs — 5-song complete journeys mapping the full 5-Act Framework
- Build full structural container before developing peak sections
- Every original track being released now is building toward a Portal EP
